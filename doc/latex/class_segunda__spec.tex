...
Definición en la línea 22 del archivo segunda\+\_\+spec.\+h.
...
Definición en la línea 14 del archivo segunda\+\_\+spec.\+cpp.
...
Definición en la línea 28 del archivo segunda\+\_\+spec.\+h.
...
Definición en la línea 17 del archivo segunda\+\_\+spec.\+cpp.


\begin{DoxyCode}
17                                  \{
18    CppUnit::TestSuite *suiteOfTests = \textcolor{keyword}{new} CppUnit::TestSuite( \textcolor{stringliteral}{"CalculatorTestSuite"} );
19 
20 
21    suiteOfTests->addTest( \textcolor{keyword}{new} CppUnit::TestCaller<Segunda\_spec>(
22                                   \textcolor{stringliteral}{"Test Sum"},
23                                   &Segunda_spec::testSum ) );
24    suiteOfTests->addTest( \textcolor{keyword}{new} CppUnit::TestCaller<Segunda\_spec>(
25                                   \textcolor{stringliteral}{"Test Subtraction"},
26                                   &Segunda_spec::testSub ) );
27    \textcolor{keywordflow}{return} suiteOfTests;
28  \}
\end{DoxyCode}
...
Definición en la línea 29 del archivo segunda\+\_\+spec.\+h.
...
Definición en la línea 35 del archivo segunda\+\_\+spec.\+h.


\begin{DoxyCode}
35                      \{
36          CPPUNIT\_ASSERT(\textcolor{keyword}{true});
37       \}
\end{DoxyCode}
...
Definición en la línea 32 del archivo segunda\+\_\+spec.\+h.


\begin{DoxyCode}
32                      \{
33          CPPUNIT\_ASSERT(\textcolor{keyword}{true});
34       \}
\end{DoxyCode}
